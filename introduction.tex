...
What do they look like – such "100% rigorous" theories? They are called formal theories (formal
...
it allows proving of ¬B, B |- ¬C (in a sense, 50% of L10!), dropping of L10 is not a very big step.
Consistency
...
theory, anything is provable. In Section 2.4 we will − without L10 − prove 50% of it: ¬B→(B→¬C).
...
applying the MP rule, we obtain A→A. Q.E.D. By performing all our replacements at the very beginning, we obtain the above
...
a) [L15, MP, Gen]: F(x)→G |- ∃xF(x)→G (a sequence of 4 formulas). What does it mean?
...
formulas, one of them being the formula B→F.
We must consider the following cases:
